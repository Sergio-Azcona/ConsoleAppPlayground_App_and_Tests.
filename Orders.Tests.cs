...
namespace ConsoleAppPlayground.Tests
{
    public class OrdersTests
    {
        ...
        public void IDs_Uniquness()
        {
            ...
            //Orders order3 = new(9, 13); cannot try to actually add an instance
            var exception3 = Assert.Throws<ArgumentException>(() => order3);
            Assert.Equal("9 is not unique.", Assert.Throws<ArgumentException>(() => new Orders(9, 13)).Message); // Should throw due to non-unique OrderID
